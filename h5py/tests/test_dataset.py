...
class TestCreateData(BaseDataset):
    ...
    def test_dataset_intermediate_group(self):
        ...
        ds = self.f.create_dataset(uid:=f"/{name()}/bar/baz", shape=(10, 10), dtype='<i4')
...
class TestCreateNamedType(BaseDataset):
    ...
    def test_named(self):
        ...
        dset = self.f.create_dataset(name("x"), (100,), dtype=self.f[name()])
        self.assertEqual(dset.dtype, np.dtype('f8'))
        self.assertEqual(dset.id.get_type(), self.f[name()].id)
...
class TestRegionRefs(BaseDataset):
    ...
    def setUp(self):
        ...
        self.dset = self.f.create_dataset(name(), data=self.data)
        self.dset[...] = self.data
